...
MAPPING_PATH = map_path("diag_cris-fsr.yaml")


class CrisFsrDiagObsBuilder(RadianceDiagObsBuilder):
    """
    CRIS-FSR Diagnostics netCDF reader: reads netCDF files containing CRIS-FSR diagnostics
    and converts them into BUFR observations according to the mapping defined in diag_cris-fsr.yaml.
    """
...
add_main_functions(CrisFsrDiagObsBuilder)